...
'基于2017-04-13 by Jimy_fengqi
'修改 Python 3.6版本
'使用 openpyxl 代替 pyExcelerator
’使用webdriver.Chrome() 代替Phantomjs(),因为selenium不再支持
'''
...
class weixin_spider:
    ...
    def __init__(self, keywords):
        ...
        self.sogou_search_url = 'http://weixin.sogou.com/weixin?type=1&query=%s&ie=utf8&s_from=input&_sug_=n&_sug_type_=' % parse.quote(
            self.keywords)
    ...
    def log(self, msg):
        print
        u'%s: %s' % (time.strftime('%Y-%m-%d_%H-%M-%S'), msg)
